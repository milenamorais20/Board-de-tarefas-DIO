...
public class BoardMenu {
    ...
    public void execute() {
        try {
            ...
            while (option != 10) {
                ...
                System.out.println("6 - Editar um card");
                System.out.println("7 - Ver board");
    ...
    private void editCard() throws SQLException {
        ...
        var cardId = scanner.nextLong();
        System.out.println("Informe o novo título do card");
        var newTitle = scanner.next();
        System.out.println("Informe a nova descrição do card");
        var newDescription = scanner.next();

        try(var connection = getConnection()){
            new CardService(connection).updateCard(cardId, newTitle, newDescription);
            System.out.println("Card editado com sucesso!");
        } catch (RuntimeException ex){
            System.out.println(ex.getMessage());
        }
    }
